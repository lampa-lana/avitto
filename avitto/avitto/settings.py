"""
Django settings for avitto project.
...
SECRET_KEY = 'django-insecure-#av=zre4o*_s&8i%-kcgu%w-k+qx)a(cvdddt$v)@a$!_cl4%='
...
WSGI_APPLICATION = 'avitto.wsgi.application'
